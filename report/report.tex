...
Both naive approaches have been implemented in Agda as well since reasoning about some properties is easier to do than in Coq. Besides the difference in implementation languages the Coq and Agda versions are identical which is why some properties are proven in Coq or Agda only and then assumed to hold in the other version as well.
